# Definición del AFN como un diccionario de transiciones
afn = {
...
def evaluar_cadena(cadena):
    ...
    for simbolo in cadena:
        if simbolo in afn[estado_actual]:  # Verificar si el símbolo es parte de las transiciones del estado actual
            ...
            print("La cadena NO es aceptada por el autómata.")  # Mostrar mensaje de rechazo
    ...
    if estado_actual == 'q1':  # Verificar si el estado actual es un estado de aceptación
        print("La cadena SI es aceptada por el autómata.")  # Mostrar mensaje de aceptación
...
def main():
    cadena = input("Ingrese la cadena a evaluar: ")  # Solicitar al usuario que ingrese la cadena a evaluar
    evaluar_cadena(cadena)  # Llamar a la función evaluar_cadena con la cadena ingresada

# Ejecución del programa principal
if __name__ == "__main__":
    main()  # Llamar a la función main si el script se ejecuta como programa principal
